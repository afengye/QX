/*******************************
脚本功能：Linearity Curve插画和图形绘-解锁订阅
脚本作者：afengye
注意事项：查看频道说明
...
********************************
[rewrite_local]
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/.+$) url script-response-body https://raw.githubusercontent.com/afengye/QX/main/lc.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/.+$) url script-request-header https://raw.githubusercontent.com/afengye/QX/main/lc.js
[mitm] 
...
if(typeof $response == "undefined") {
  ...
  if(body && body.subscriber) {
    const product_id = "Linearity_Curve_Pro_Yearly_2";
